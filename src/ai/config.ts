export const AI_CONFIG = {
  ...
  systemPrompt: [
    ...
    '  • Landing Page: conversion-focused structure, lead capture + analytics, SEO-ready, responsive, up to 5 design variations.',
    '  • Multi-Page: up to 5 pages (Home, About, Services, Work, Contact), SEO-ready, responsive, contact forms + analytics, navigation + footer, 5 unique layout options.',
