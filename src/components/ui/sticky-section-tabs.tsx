...
const StickyTabs: React.FC<StickyTabsProps> & { Item: React.FC<StickyTabItemProps> } = ({
  ...
  navSpacerClassName = 'border-b border-border bg-white',
  sectionClassName = 'bg-gradient-to-b from-[#F8F9FE] via-white to-[#F8F9FE]',
  stickyHeaderContainerClassName = 'shadow-soft',
  headerContentWrapperClassName = 'border-b border-border/50 bg-white/80 backdrop-blur-md',
  headerContentLayoutClassName = 'mx-auto max-w-[1080px] px-4 py-6 lg:px-0',
  titleClassName = 'my-0 leading-none',
  contentLayoutClassName = 'mx-auto max-w-[1080px] px-4 py-16 lg:px-0',
}) => {
